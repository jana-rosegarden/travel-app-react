...
export default function Main(){
    return(
        <main className="main-haupt">
           <Link to="/category/strands" className="link-haupt-kategorien" role="button"> Strände</Link>
           <Link to="/category/restaurants" className="link-haupt-kategorien" role="button"> Essen </Link>
           ...
           <Link to="category/spielplatz" className="link-haupt-kategorien" role="button"> Parks & Spielplätze</Link>
