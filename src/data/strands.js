export const strands = [
    ...
    },
    {
        ...
        isKostenfrei: true,
        parken: {
            de: "In der näheren Umgebung sind kostenlose Parkplätze vorhanden",
            uk: "У найближчих околицях є безкоштовні паркувальні місця"
        },
        info: {
    ...
    },
    {
        ...
        isKostenfrei: true,
        parken: {
            de: "Das Parken ist direkt an der Straße Lungomare möglich. Dies ist jedoch gebührenpflichtig. Da der Strand sehr beliebt ist, wird empfohlen, frühzeitig zu kommen. ",
            uk: "Паркуватися можна безпосередньо на вулиці Лунгомаре. Однак це платна послуга. Оскільки пляж дуже популярний, рекомендуємо приїжджати заздалегідь. "
        },
        info: {
    ...
    },
    {
        ...
        isKostenfrei: true,
        parken: {
            de: "Kostenlose Parkplätze stehen direkt neben dem Pinienwald zur Verfügung und bieten schattige Stellplätze nur wenige Gehminuten vom Meer entfernt. An Sommerwochenenden kann der Parkplatz schnell voll sein, daher wird eine frühzeitige Ankunft empfohlen.",
            uk: "Безкоштовні паркувальні місця розташовані безпосередньо біля соснового лісу; це затінені стоянки, що знаходяться всього за декілька хвилин ходьби від моря. У літні вихідні парковка може швидко заповнитися, тому рекомендуємо приїжджати заздалегідь."
        },
        info: {
    ...
    },
    {
        ...
        isKostenfrei: true,
        parken: {
            de: "In der Nähe der Küste gibt es einen öffentlichen Parkplatz, der jedoch in den Sommermonaten schnell belegt ist.",
            uk: "Неподалік від узбережжя є громадська автостоянка, яка, однак, у літні місяці швидко заповнюється."
        },
        info: {
    ...
    },
    {
        ...
        isKostenfrei: true,
        parken: {
            de: "Es gibt zwei bequeme Alternativen: Option 1: Kostenlose Parkplätze in der Nähe des E&D Caffe – nur wenige Gehminuten vom Strand entfernt. Option 2: Bitten Sie den Wachmann am Eingang des Verudela-Camps um Einlass; innerhalb des Resortgeländes stehen mehrere Parkplätze zur Verfügung.",
            uk: "Є дві зручні альтернативи: Варіант 1: Безкоштовні паркувальні місця поблизу E&D Caffe — лише за кілька хвилин ходьби від пляжу. Варіант 2: Попросіть охоронця біля входу в курорт Verudela пропустити вас; на території курорту є кілька паркувальних місць."
        },
        info: {
