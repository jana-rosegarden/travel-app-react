...
export const sehenswuerdigkeiten = [
    
    {
        ...
        adresse: {
            ...
            uk: "Градінський підйом, 10, 52100, Пула"
        },
        entfernung: 4.3,
        price: {
            de: "Erwachsene: 7 €, Kinder/Studenten/Senioren (65+): 3 €",
            uk: "Дорослі: 7 євро, діти/студенти/пенсіонери (65+): 3 євро"
        },
        info: {
            ...
            uk: "Цитадель Пули (Каштель) — це фортеця у формі зірки, збудована у XVII столітті, яка височіє на центральному пагорбі над Старим містом. Звідти відкривається вражаючий панорамний вид на місто, гавань та амфітеатр. Сьогодні в Каштелі розміщується Історичний та морський музей Істрії."
        },
        oeffnungszeiten: {
            de: "Von Mai bis September ist sie täglich von 08:00/09:00 bis 21:00 Uhr geöffnet",
            uk: "З травня по вересень вона працює щодня з 08:00/09:00 до 21:00"
        },
    ...
    },
    {
        name: {
            ...
            uk: "Місце з краєвидом"
        },
        adresse: {
            de: "52100, Pješčana Uvala, Хорватия",
            uk: "52100, Пєщана Увала, Хорватія"
        },
        entfernung: 2.6,
        price: {
            de: "Kostenfrei",
    ...
    },
    {
        ...
        adresse: {
            ...
            uk: "Вул. Марсового поля, 10, 52100, Пула"
        },
        entfernung: 2.3,
        price: {
            de: "Kostenfrei",
        ...
        info: {
            ...
            uk: "Торговий павільйон: архітектурна перлина часів Австро-Угорської імперії (конструкція зі сталі та скла). Асортимент: свіжа риба, м’ясо, сир, фрукти, овочі та місцеві делікатеси."
        },
        oeffnungszeiten: {
            ...
            uk: "У будні та суботу ринок зазвичай працює з 7:00 до 13:00 або 14:00 (торгові ятки) та до 15:00 (магазини). Рибний ринок часто закривається близько 13:00. У неділю години роботи скорочені, зазвичай до 12:00."
        },
    ...
    },
    {
        name: {
            ...
            uk: "Нульова вулиця (підземна система тунелів)"
        },
        adresse: {
            de: "Carrarina ul. 3, 52100, Pula",
            uk: "Вул. Карраріна, 3, 52100, Пула"
        },
        entfernung: 3.8,
        price: {
            de: "Erwachsene: 7 €, Kinder (5–16 Jahre): 3 €, Familienkarte: ca. 15 €",
            uk: "Дорослі: 7 євро, діти (5–16 років): 3 євро, сімейний квиток: приблизно 15 євро"
        },
        info: {
            ...
            uk: "Зероштрассе — це захоплююча система підземних тунелів, розташована безпосередньо під Старим містом Пули. Вона дає змогу зануритися у військову історію міста. Час будівництва: споруджено під час Першої світової війни (Австро-Угорщина). Призначення: слугувало як протиповітряний бункер для населення та як склад боєприпасів. Місткість: тунелі могли надати притулок до 6 000 людей. Прохолодний клімат: у тунелях протягом усього року підтримується постійна температура 14–18 °C. Навіть влітку рекомендується взяти з собою легку куртку. Комбінована перевага: за квитком зазвичай можна скористатися ліфтом, що веде прямо з вулиці Зеро до фортеці Каштел, звідки відкривається чудовий панорамний вид на Пулу."
        },
        oeffnungszeiten: {
            de: "Mai – September: Täglich von 09:00 bis 21:00 Uhr",
            uk: "Травень – вересень: щодня з 09:00 до 21:00"
        },
    ...
    },
     {
        ...
        adresse: {
            ...
            uk: "Forum b.b, 52100, Пула"
        },
        entfernung: 3.0,
        price: {
            de: "Preis: Erwachsene ca. 2 €, Schüler/Studenten ca. 1 €.",
            uk: "Ціна: дорослі — приблизно 2 євро, школярі/студенти — приблизно 1 євро."
        },
        info: {
            ...
            uk: "Храм Августа в Пулі (Хорватія) — це чудово збережений римський периптерний храм I століття н. е. (приблизно 2 р. до н. е. — 14 р. н. е.), присвячений богині Ромі та імператору Августу. Він розташований на Форумі в центрі Старого міста і відомий своїми шістьма коринфськими колонами висотою близько 8 метрів."
        },
        oeffnungszeiten: {
            de: "Mai, Juni, September: 09:00 – 20:00 Uhr",
            uk: "Травень, червень, вересень: 09:00 – 20:00"
        },
    ...
    },
    {
        ...
        adresse: {
            ...
            uk: "Вул. Флавієвська, 52100, Пула"
        },
        entfernung: 3.6,
        price: {
            de: "Erwachsene: 10 € pro Person. Ermäßigte Tickets für Kinder, Schüler und Studenten: 5 €, Kinder unter 5 Jahren:  frei.",
            uk: "Дорослі: 10 євро з особи. Квитки за пільговим тарифом для дітей, школярів та студентів: 5 євро, діти до 5 років: безкоштовно."
        },
        info: {
            ...
            uk: "Амфітеатр у Пулі (Пульська Арена) — це вражаюча римська споруда, зведена в I столітті н. е. на хорватському узбережжі Адріатичного моря. Це шостий за величиною римський амфітеатр у світі та один із найкраще збережених: його величний зовнішній фасад із білого вапняку зберігся майже повністю."
        },
        oeffnungszeiten: {
            de: "Mai: 08:00 – 21:00 Uhr",
            uk: "Травень: 08:00 – 21:00"
        },
